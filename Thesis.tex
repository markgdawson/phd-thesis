...
\input{./Chapters/2.Physical_Problem.tex}
\input{./Chapters/3.Numerical_Methods.tex}
\input{./Chapters/4.DG_method.tex}
%\input{./Chapters/Results}
%\input{./Chapters/5.Parallelisation.tex}
%\input{./Chapters/6.SignalAnalysis.tex}
% \input{./Chapters/Appendix.AnalyticalWaves}
% \input{./Chapters/Appendix.2D_FEM_Propagation}
% \input{./Chapters/Appendix.2D_Plate}
...
% \input{./Chapters/Appendix.MPI}
% \input{./Chapters/Appendix.Numerical_DGTD_2D_Simulations}
