...
\begin{figure}[!ht]
	\centering
  \subfigure[4$\times$2 ]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/spectra/spectrum2x4}\label{fig:2D_FreeSpaceCavity:2x4_spectra}}
  \subfigure[16$\times$8 ]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/spectra/spectrum8x16}\label{fig:2D_FreeSpaceCavity:8x16_spectra}}	\caption{Rectangular free space cavity: spectra for two meshes of quadrilaterals for different $p$.}
\end{figure}
...
Figure~\ref{fig:2D_FreeSpaceCavity:8x16_spectra}
\begin{itemize}
