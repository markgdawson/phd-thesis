...
\begin{figure}[!ht]
	\centering
  \subfigure[4$\times$2 ]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/spectra/spectrum2x4}}
  \subfigure[16$\times$8 ]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/spectra/spectrum8x16}}
...
\begin{figure}[!ht]
   ...
   \subfigure[$f_{2} \approx, \USoltn_{1}, \TEz $]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/Conv/U[1]/F2_TE}}
   \subfigure[$f_{3} \approx, \USoltn_{3}, \TMz $]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/Conv/U[3]/F3_TM}}
   \subfigure[$f_{6} \approx, \USoltn_{2}, \TMz $]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/Conv/U[2]/F6_TM}}
   \subfigure[$f_{8} \approx, \USoltn_{3}, \TMz $]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/Conv/U[3]/F8_TM}}
   \subfigure[$f_{10} \approx, \USoltn_{3}, \TMz $]{\includegraphics[width=0.49\textwidth]{2D_FreeSpaceCavity/Conv/U[3]/F10_TM}}
...
\begin{figure}[!ht]
	\centering
\subfigure[$\Delta t = 0.025$]{\includegraphics[width=\textwidth]{2D_FreeSpaceCavity/Aliasing/4x8_p3_TM_notaliased}} \\
\subfigure[$\Delta t = 0.2$]{\includegraphics[width=\textwidth]{2D_FreeSpaceCavity/Aliasing/4x8_p3_TM_dt0_2}} \\
\subfigure[$\Delta t = 0.4$]{\includegraphics[width=\textwidth]{2D_FreeSpaceCavity/Aliasing/4x8_p3_TM_aliased}} \\
...
\begin{figure}[!ht]
	\centering
\subfigure[$T=10$]{\includegraphics[width=0.49\textwidth]{Windows/spectra/BlackmanHarris-T10}} \subfigure[$T=100$]{\includegraphics[width=0.49\textwidth]{Windows/spectra/BlackmanHarris-T100}}
\subfigure[$T=1000$]{\includegraphics[width=0.49\textwidth]{Windows/spectra/BlackmanHarris-T1000}}
\subfigure[$T=10000$]{\includegraphics[width=0.49\textwidth]{Windows/spectra/BlackmanHarris-T10000}}
\end{figure}
%figure: DONE various windows (spectra)
\begin{figure}[!ht]
	\centering
\subfigure[ Rectangular window]{\includegraphics[width=\textwidth]{2D_FreeSpaceCavity/Windows/spectra/RectWindow}}
\subfigure[ Blackman window]{\includegraphics[width=\textwidth]{2D_FreeSpaceCavity/Windows/spectra/BlackmanWindow}}
\subfigure[ Blackman-Harris window]{\includegraphics[width=\textwidth]{2D_FreeSpaceCavity/Windows/spectra/BlackmanHarrisWindow}}
\subfigure[ Gaussian window]{\includegraphics[width=\textwidth]{2D_FreeSpaceCavity/Windows/spectra/GaussianWindow}}
\end{figure}
...
\begin{figure}[!ht]
	\centering
\subfigure[]{\includegraphics[width=0.49\textwidth]{AdaptiveP/localConvergenceFrame0_legend}}
\subfigure[]{\includegraphics[width=0.49\textwidth]{AdaptiveP/localConvergenceFrame1}}
\end{figure}
\begin{figure}[!ht]
	\centering
  \includegraphics[width=\textwidth]{AdaptiveP/nestedElementsWithoutP}
\caption{3D unit cube: histograms of p and element size}
	\label{fig:unitCubeNonUniformTimings}
\end{figure}
% text TODO
