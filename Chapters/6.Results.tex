...
\begin{equation*}
\hat{\Unodal}_j(f_k) = \sum_{n=0}^{\nT-1} \Unodal_j (t_n) \exp(-i2\pi t_n f_k), \quad j=1,\cdots,\nnode,
\end{equation*}
...
The TM mode is considered and the frequencies are computed using a series of structured quadrilateral meshes with 4$\times$2, 8$\times$4, 16$\times$8, 32$\times$16 and 64$\times$32 elements and different degrees of approximation. Figure~\ref{fig:rectangle2DfreeSpace_Convergence} shows the evolution of the error on four computed resonant frequencies as a function of the element size for a degree of approximation $p$ ranging from 1 up to 3. 
%figure
\begin{figure}[!ht]
	\centering
	\subfigure[$f_3 \approx$  8.38 THz]{\includegraphics[width=0.49\textwidth]{figs/FreeSpace2D_f2_hConv}}
	\subfigure[$f_4 \approx$ 10.60 THz]{\includegraphics[width=0.49\textwidth]{figs/FreeSpace2D_f3_hConv}}\\
	\subfigure[$f_6 \approx$ 13.51 THz]{\includegraphics[width=0.49\textwidth]{figs/FreeSpace2D_f5_hConv}}
	\subfigure[$f_9 \approx$ 16.76 THz]{\includegraphics[width=0.49\textwidth]{figs/FreeSpace2D_f6_hConv}}
	\caption{Rectangular free-space cavity: $h$-convergence of the error for four resonant frequencies.}
...
\begin{figure}[!ht]
	\centering
	\subfigure[$f_3 \approx$  8.38 THz]{\includegraphics[width=0.24\textwidth]{figs/rectangleFreeSpace_U2_Mode2}}
	\subfigure[$f_4 \approx$ 10.60 THz]{\includegraphics[width=0.24\textwidth]{figs/rectangleFreeSpace_U2_Mode3}}
	\subfigure[$f_6 \approx$ 13.51 THz]{\includegraphics[width=0.24\textwidth]{figs/rectangleFreeSpace_U2_Mode5}}
	\subfigure[$f_9 \approx$ 16.76 THz]{\includegraphics[width=0.24\textwidth]{figs/rectangleFreeSpace_U2_Mode6}} 
...
\begin{figure}[!ht]
	\centering
	\subfigure[$E_1$]{\includegraphics[width=0.45\textwidth]{figs/rectangleFreeSpace_2x4_p4_f15_U1}}
	\hspace{1cm}
	\subfigure[$H_1$]{\includegraphics[width=0.45\textwidth]{figs/rectangleFreeSpace_2x4_p4_f15_U4}}
...
\begin{figure}[!ht]
	\centering
	\subfigure[$h$-refinement]{\includegraphics[width=0.49\textwidth]{figs/circleFreeSpace_hRef}}
	\subfigure[$p$-refinement]{\includegraphics[width=0.49\textwidth]{figs/circleFreeSpace_pRef}}
...
\begin{figure}[!ht]
\centering
\subfigure[$f_1 \approx$ 57.37 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode1_U3}}
\subfigure[$f_2 \approx$ 91.41 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode2_U3}}
\subfigure[$f_3 \approx$ 122.52 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode3_U3}}
\subfigure[$f_{14} \approx$ 263.97 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode14_U3}} \\
%
\subfigure[$f_4 \approx$ 131.69 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode4_U3}}
\subfigure[$f_6 \approx$ 167.37 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode6_U3}}
\subfigure[$f_5 \approx$ 152.21 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode5_U3}}
\subfigure[$f_{19} \approx$ 294.36 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode19_U3}} \\
%
\subfigure[$f_{17} \approx$ 281.31 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode17_U3}}
\subfigure[$f_{13} \approx$ 242.71 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode13_U3}}
\subfigure[$f_7 \approx$ 181.03 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode7_U3}}
\subfigure[$f_{20} \approx$ 310.50 THz]{\includegraphics[width=0.24\textwidth] {figs/circleFreeSpace_mode20_U3}} 
...
\begin{figure}[!ht]
	\centering
	\subfigure[]{\includegraphics[width=0.49\textwidth]{figs/circleFreeSpace_ndof}}
	\subfigure[]{\includegraphics[width=0.49\textwidth]{figs/circleFreeSpace_cpu}}
...
\begin{figure}[!ht]
	\centering
	\subfigure[$f_3 \approx$ 8.59 THz ]{\includegraphics[width=0.49\textwidth]{figs/dispersive_f3_hConv}}
	\subfigure[$f_6 \approx$ 13.64 THz]{\includegraphics[width=0.49\textwidth]{figs/dispersive_f6_hConv}}
...
%============================================================
\subsection{Three dimensional cavity}
%============================================================
%text
...
Figure~\ref{fig:cube3DfreeSpace_Convergence} shows the evolution of the error on two computed resonant frequencies as a function of the element size for a degree of approximation $p$ ranging from 1 up to 3.
% figure
\begin{figure}[!ht]
	\centering
	\subfigure[$f_4 \approx$  167.59 THz]{\includegraphics[width=0.49\textwidth]{figs/cube_HEX_f5_hConv}}
	\subfigure[$f_9 \approx$  248.57 THz]{\includegraphics[width=0.49\textwidth]{figs/cube_HEX_f10_hConv}}
	\caption{Three dimensional cavity: $h$-convergence of the error for two resonant frequencies.}
	\label{fig:cube3DfreeSpace_Convergence}
\end{figure}
%
...
\begin{figure}[!ht]
	\centering
	\subfigure[$E_1$]{\includegraphics[width=0.32\textwidth] {figs/Cube_Mode2_U1}}
	\subfigure[$E_2$]{\includegraphics[width=0.32\textwidth] {figs/Cube_Mode2_U2}}
	\subfigure[$E_3$]{\includegraphics[width=0.32\textwidth] {figs/Cube_Mode2_U3}}
...
To further illustate the potential of the proposed methodology, Figure~\ref{fig:cubeFreeSpace_modes} shows the intensity of the electric and magnetic fields for four resonant modes, associated to the resonant frequencies $f_4\approx$ 167.59 THz, $f_6\!\approx$ 211.99 THz, $f_{35} \approx$ 491.47 THz and $f_{36} \approx$ 502.77 THz.
% figure
\begin{figure}[!ht]
	\centering
	\subfigure[$\!\!\!E, f_4\!\approx$167.6 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode5_E}}
	\subfigure[$\!\!\!E, f_6\!\approx$212.0 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode7_E}}
	\subfigure[$\!\!\!E, f_{35}\!\approx$491.5 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode36_E}}
	\subfigure[$\!\!\!E, f_{36}\!\approx$502.8 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode37_E}} \\
	\subfigure[$\!\!\!H, f_4\!\approx$167.6 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode5_H}}
	\subfigure[$\!\!\!H, f_6\!\approx$212.0 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode7_H}}
	\subfigure[$\!\!\!H, f_{35}\!\approx$491.5 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode36_H}}
	\subfigure[$\!\!\!H, f_{36}\!\approx$502.8 THz]{\includegraphics[width=0.24\textwidth]{figs/Cube_Mode37_H}} 
