...
something to do with height being $1/(\pi T_2)$ Hz % why Hz ???
...
%note Dispersion line ISNT realted to derivative line of ESR spectra
...
% check that it IS the absolute value that I should be taking
...
* linear prediction
* FDM
% thats what it says in http://www-keeler.ch.cam.ac.uk/lectures/understanding/chapter_4.pdf
