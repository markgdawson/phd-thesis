...
% TODO: Ruben questioned the SI units - should they be specified - I'm not sure
\begin{subequations}
\begin{align}
...
By applying Stokes' Theorem to~\eqref{eq:maxwell-faraday-integral} and~\eqref{eq:maxwell-ampere-integral} and Gauss' law to~\eqref{maxwell-gauss-integral} and~\eqref{maxwell-gauss-magnetism-integral}, the equations in differential form are readily obtained as
\begin{subequations}
...
% TODO - do I need to explain what this means
\begin{subequations}
...
% TODO - the following equation should be rewritten as in Rubens paper - it isn't clear how these arrise from previous equation
\begin{subequations}
...
% TODO - explicit mathematical relationship for circumflex, and how it relates to Fourier transform
...
\label{eq:drude-ampere}
    ...
    \end{align}
\end{subequations}
% TODO - Ruben put a note on this equation saying 'the norm is that as soon as a variable is introduced it must be defined' - is that not done here? Is there anything which is not previously defined?
...
% TODO - Ruben commented on the ADE acronym - I think this is fine
